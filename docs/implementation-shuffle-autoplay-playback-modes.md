...
Status: **draft implementation work order on current `main` after PR #235**.

PR #235 has been accepted and merged. This branch has been realigned onto that merge result before implementation begins.

Implementation base: `875be255b558dd05392fcb4f5ecb70694f19e35b`.
...
## 19. Base and workflow

PR #235 is already merged. This PR now targets current `main`.

Implement Shuffle + Auto Play directly on this branch.

Before final acceptance:

1. confirm the branch still contains the #235 lifecycle/recovery guarantees;
2. rerun all validation and actual-Tauri visual acceptance on the final exact head;
3. keep this PR Draft until independent review;
4. do not merge as part of Codex implementation.
