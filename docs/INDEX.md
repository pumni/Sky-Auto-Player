...
* [2026-07_core-dispatch-refactor-and-isolation-plan.md](2026-07_core-dispatch-refactor-and-isolation-plan.md) — **In progress (Phases 0–2 landed; next = Phase 3).** Phased refactor from the 2026-07-16 core review. See plan §12 for as-built progress. Phase 0 harness + Phase 1 correctness (A1/A2/A6a/A6b) + Phase 2 hot-path (A3 telemetry flush off RT, A4 cheap focus, unfocused hook). **Must be completed before rust-migration-plan.md Phase 0 starts.**
