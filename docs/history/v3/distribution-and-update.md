# Historical V3 Distribution and Update Mechanics (Non-normative)

> [!NOTE]
> This document preserves the historical v3 portable ZIP, Ed25519 `MANIFEST.json`, and
> standalone `Sky-Auto-Player-Updater.exe` transaction and recovery mechanics.
> These mechanisms are superseded for v4 by the official Tauri updater and NSIS installer.
> For the current active distribution and update contracts, see
> [distribution-and-update.md](../../distribution-and-update.md),
> [v4-tauri-packaging.md](../../v4-tauri-packaging.md), and
