...
pub(super) struct NativeDispatchSessionPy {
    pub(super) session: Arc<NativeDispatchSession>,
    pub(super) effective_config: EffectiveSessionConfig,
}

#[derive(Clone, Default)]
pub(super) struct EffectiveSessionConfig {
    game_fps: u16,
...
impl NativeDispatchSessionPy {
    ...
    pub(super) fn snapshot<'py>(&self, py: Python<'py>) -> PyResult<Bound<'py, PyDict>> {
