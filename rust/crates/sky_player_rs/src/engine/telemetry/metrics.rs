...
pub struct WorkerMetricsLocal {
    ...
    /// Production musical deadline recovery evidence. These are scalar-only
    ...
    pub production_structural_anomaly_count: u64,
    pub production_timing_diagnostic_count: u64,
