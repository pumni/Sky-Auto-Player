...
impl NativeDispatchSession {
    ...
    pub fn snapshot_lite(&self) -> EngineProgressSnapshot {
        ...
        EngineProgressSnapshot {
            ...
            max_sendinput_entry_lateness_us: local.max_sendinput_entry_lateness_us,
            entry_late_2ms: local.entry_late_2ms,
            entry_late_5ms: local.entry_late_5ms,
            entry_late_10ms: local.entry_late_10ms,
