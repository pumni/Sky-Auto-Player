...
pub struct EngineSnapshot {
    ...
    pub last_missed_down_reason: Option<String>,
    pub last_missed_down_source_action_index: Option<u32>,
    ...
    pub requested_rt_priority_mode: String,
    pub rt_priority_acquired: String,
    pub requested_wait_policy: String,
    pub effective_wait_policy: String,
    pub startup_calibration_executed: bool,
    pub startup_calibration_sample_count: u64,
    pub startup_wake_error_p50_us: u64,
    pub startup_wake_error_p95_us: u64,
    pub startup_wake_error_p99_us: u64,
    pub startup_wake_error_max_us: u64,
    pub startup_wake_error_robust_us: u64,
    pub effective_spin_threshold_us: u64,
    pub spin_threshold_source: String,
