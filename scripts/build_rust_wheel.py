...
def generate_application_build_metadata(repo_root: Path, build_commit: str) -> Path:
    """Generate the startup admission metadata consumed by the application."""

    path = repo_root / "src" / "sky_music" / "_native_build.py"
    path.write_text(
        "# Auto-generated by build_rust_wheel.py — do not edit manually.\n"
        f'APP_BUILD_COMMIT: str = "{build_commit}"\n',
        encoding="utf-8",
    )
    return path
...
def main() -> int:
    ...
    generate_application_build_metadata(repo_root, expected_commit)
